...
// SW_Tx_UART_v1_50(BaudRate=9600, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONFIG_TITLE=MyUART_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=MyUART_1, CY_INSTANCE_SHORT_NAME=MyUART_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=MyUART_1, )
module SW_Tx_UART_v1_50_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c1e7464d-98a1-4aa8-9873-1c6f12afba75/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__VR_EN_net;
	wire [0:0] tmpFB_0__VR_EN_net;
	wire [0:0] tmpIO_0__VR_EN_net;
	wire [0:0] tmpINTERRUPT_0__VR_EN_net;
	electrical [0:0] tmpSIOVREF__VR_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("aaf82a43-2e32-440c-900e-c861fd93afdf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		VR_EN
		 (.oe(tmpOE__VR_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VR_EN_net[0:0]}),
		  .io({tmpIO_0__VR_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__VR_EN_net),
		  .interrupt({tmpINTERRUPT_0__VR_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VR_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LF_Relay_net;
	wire [0:0] tmpFB_0__LF_Relay_net;
	wire [0:0] tmpIO_0__LF_Relay_net;
	wire [0:0] tmpINTERRUPT_0__LF_Relay_net;
	electrical [0:0] tmpSIOVREF__LF_Relay_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1a6ccd03-574d-43ed-a909-2aaceb621304"),
		  ...
		  .input_buffer_sel(2'b00))
		LF_Relay
		 (.oe(tmpOE__LF_Relay_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LF_Relay_net[0:0]}),
		  .io({tmpIO_0__LF_Relay_net[0:0]}),
		  .siovref(tmpSIOVREF__LF_Relay_net),
		  .interrupt({tmpINTERRUPT_0__LF_Relay_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LF_Relay_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HF_Relay_net;
	wire [0:0] tmpFB_0__HF_Relay_net;
	wire [0:0] tmpIO_0__HF_Relay_net;
	wire [0:0] tmpINTERRUPT_0__HF_Relay_net;
	electrical [0:0] tmpSIOVREF__HF_Relay_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9d859e35-131c-42eb-95ef-ceb85d387a15"),
		  ...
		  .input_buffer_sel(2'b00))
		HF_Relay
		 (.oe(tmpOE__HF_Relay_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HF_Relay_net[0:0]}),
		  .io({tmpIO_0__HF_Relay_net[0:0]}),
		  .siovref(tmpSIOVREF__HF_Relay_net),
		  .interrupt({tmpINTERRUPT_0__HF_Relay_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HF_Relay_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__COMP_Relay_net;
	wire [0:0] tmpFB_0__COMP_Relay_net;
	wire [0:0] tmpIO_0__COMP_Relay_net;
	wire [0:0] tmpINTERRUPT_0__COMP_Relay_net;
	electrical [0:0] tmpSIOVREF__COMP_Relay_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b99fbfca-9370-433d-9143-d0d46c7ddac0"),
		  ...
		  .input_buffer_sel(2'b00))
		COMP_Relay
		 (.oe(tmpOE__COMP_Relay_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__COMP_Relay_net[0:0]}),
		  .io({tmpIO_0__COMP_Relay_net[0:0]}),
		  .siovref(tmpSIOVREF__COMP_Relay_net),
		  .interrupt({tmpINTERRUPT_0__COMP_Relay_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__COMP_Relay_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LF_CB_net;
	wire [0:0] tmpFB_0__LF_CB_net;
	wire [0:0] tmpIO_0__LF_CB_net;
	wire [0:0] tmpINTERRUPT_0__LF_CB_net;
	electrical [0:0] tmpSIOVREF__LF_CB_net;

	cy_psoc3_pins_v1_10
		#(.id("bd7b1e59-d1ed-4580-951d-6b71787d479a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		LF_CB
		 (.oe(tmpOE__LF_CB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LF_CB_net[0:0]}),
		  .io({tmpIO_0__LF_CB_net[0:0]}),
		  .siovref(tmpSIOVREF__LF_CB_net),
		  .interrupt({tmpINTERRUPT_0__LF_CB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LF_CB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HF_CB_net;
	wire [0:0] tmpFB_0__HF_CB_net;
	wire [0:0] tmpIO_0__HF_CB_net;
	wire [0:0] tmpINTERRUPT_0__HF_CB_net;
	electrical [0:0] tmpSIOVREF__HF_CB_net;

	cy_psoc3_pins_v1_10
		#(.id("a9e3f7ed-769e-40f0-8d4e-6226b9e43440"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		HF_CB
		 (.oe(tmpOE__HF_CB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HF_CB_net[0:0]}),
		  .io({tmpIO_0__HF_CB_net[0:0]}),
		  .siovref(tmpSIOVREF__HF_CB_net),
		  .interrupt({tmpINTERRUPT_0__HF_CB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HF_CB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__COMP_CB_net;
	wire [0:0] tmpFB_0__COMP_CB_net;
	wire [0:0] tmpIO_0__COMP_CB_net;
	wire [0:0] tmpINTERRUPT_0__COMP_CB_net;
	electrical [0:0] tmpSIOVREF__COMP_CB_net;

	cy_psoc3_pins_v1_10
		#(.id("b92b1a9e-4f28-4ee4-982a-63796a9a108b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		COMP_CB
		 (.oe(tmpOE__COMP_CB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__COMP_CB_net[0:0]}),
		  .io({tmpIO_0__COMP_CB_net[0:0]}),
		  .siovref(tmpSIOVREF__COMP_CB_net),
		  .interrupt({tmpINTERRUPT_0__COMP_CB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__COMP_CB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1a2b52a8-e89a-416b-bb34-c4f47db0214e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6065134c-ca44-4077-8f58-593e77b2f07f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
