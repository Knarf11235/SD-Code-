...
;==============================================================================
    ...
    IMPORT MyUART_1_pinNumber
    IMPORT MyUART_1_pinPortNumber
    IMPORT MyUART_1_pinDrAdress
...
;-------------------------------------------------------------------------------
; Function Name: MyUART_1_PutChar
;-------------------------------------------------------------------------------
;
; Summary:
...
; void MyUART_1_PutChar(uint8 txDataByte)
    ALIGN 8
MyUART_1_PutChar FUNCTION
    EXPORT MyUART_1_PutChar
...
PIN_NUMBER DCD MyUART_1_pinNumber
PORT_NUMBER DCD MyUART_1_pinPortNumber
PORT_DR_ADDRESS DCD MyUART_1_pinDrAdress
